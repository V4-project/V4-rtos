...
All notable changes to the V4 Runtime HAL integration will be documented in this file.
...
- Alias target `v4_hal` for consistent linking across V4 Runtime components
